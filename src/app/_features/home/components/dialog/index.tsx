    ...
    <Dialog open={!!selectedItem} onOpenChange={onClose}>
      <DialogContent className="p-0 focus:outline-none" showCloseButton={false}>
        ...
        <Card
          ...
          style={{ backgroundImage: `url(${selectedItem?.img_source})` }}
        >
              ...
              <div className="flex flex-col">
                ...
                <div className="flex">
                  <div className="flex-1">
                    <ul>
                      <li>{selectedItem?.place_name}</li>
                      <li>{selectedItem?.min_age}세 이상 관람가</li>
                      <li>{selectedItem?.running_time_minute}분</li>
                      <li>
